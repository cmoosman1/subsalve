...
import AboutUsTimelineMobile from './AboutUsTimelineMobile';
import styled from 'styled-components';

export default class AboutUsTimeline extends Component {
  constructor(props) {
    super(props);
    this.state = {
      events: this.props.fields,
      // singleImage: null,
      activeIndex: 0,
  ...
  render() {
    ...
    .timeline-controls {
      ...
      .timeline-image-section {
        row > .timeline-img1, row > .timeline-img2  {
          overflow: hidden;
          max-height: 300px;
        }
      }
    ...
    return (
        <div>
                ...
                <div className="row">
                    ...
                    <ol className="timelime-list">
                        ...
                        <div className="timeline-info-section col-10">
                            ...
                            ? 
                            <div className="row">
                                <div className="timeline-img1 col-6 pr-0 pl-0" style={{overflow:'hidden', maxHeight: '300px'}}>
                                <img src={eventImages[`${this.state.activeIndex}`][0]} alt="" />
                                </div>
                                <div className="timeline-img2 col-6 pr-0 pl-0" style={{overflow:'hidden', maxHeight: '300px'}}>
                            ...
                            <div className="row">
                                <div className="timeline-img1 col-12 pr-0 pl-0" style={{overflow:'hidden', maxHeight: '300px'}}>
                                  <img src={this.state.events[this.state.activeIndex].single_image} alt="image" />
                                </div>
                            </div>
                            }
                            <div className="row">
            ...
            {isMobile &&
                <AboutUsTimelineMobile fields={events}/>
            }
        </div>
    )
  }
