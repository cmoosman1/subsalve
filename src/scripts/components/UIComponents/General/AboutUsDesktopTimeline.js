        ...
        <div className="timeline-container container">
                ...
                {events.map((i, key) => {
                  return (
                    <li className="timeline-info-left" key={key}>
                      <div className="timeline-year-left">{i.year}</div>
                      <div className="timeline-subtitle-left">{i.title}</div>
          ...
          <div className="timeline-info-section col-10">
            ...
            <div className="timeline-image-section container">
              {!this.state.isNotSingle
              ? 
              <div className="row">
                <div className="timeline-img1 col-6 pr-0 pl-0" style={{maxHeight: '300px', overflow: 'hidden'}}>
                  <img src={eventImages[`${this.state.activeIndex}`][0]} alt="" />
                </div>
                <div className="timeline-img2 col-6 pr-0 pl-0" style={{maxHeight: '300px', overflow: 'hidden'}}>
                  <img src={eventImages[`${this.state.activeIndex}`][1]} alt="" />
                </div>
              </div>
              :
              <div className="row">
                <div className="timeline-img1 col-12 pr-0 pl-0" style={{maxHeight: '300px', overflow: 'hidden'}}>
                  if(eventMediaSingle.length > 0){
